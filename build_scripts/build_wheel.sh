...
function build_wheel() {
    ...
    # mv getml-$VERSION_NUMBER-py3-none-manylinux_2_17_$WHEEL_ARCH.whl getml-$VERSION_NUMBER-py38-none-manylinux_2_17_$WHEEL_ARCH.whl || exit 1

    #rm -rf wheelhouse || exit 1
    #auditwheel addtag getml-$VERSION_NUMBER-py3-none-manylinux_2_17_$WHEEL_ARCH.whl || exit 1
    ...
    cp getml-*.whl $GETML_BUILD_FOLDER || exit 1
}
