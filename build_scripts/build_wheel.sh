...
function build_wheel() {
    ...
    mv getml-$VERSION_NUMBER-py3-none-any.whl getml-$VERSION_NUMBER-py38-none-manylinux_2_28_$WHEEL_ARCH.whl || exit 1

    rm -rf wheelhouse || exit 1
    auditwheel addtag getml-$VERSION_NUMBER-py38-none-manylinux_2_28_$WHEEL_ARCH.whl || exit 1
