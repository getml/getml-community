...
class DecisionTreeNode {
 ...
 public:
  ...
  Float transform(const containers::DataFrameView& _output,
                  const std::optional<containers::DataFrame>& _input,
                  const containers::Subfeatures& _subfeatures,
                  const containers::Rescaled& _output_rescaled,
                  const containers::Rescaled& _input_rescaled,
 ...
 private:
  ...
  void add_candidates(const enums::Revert _revert, const enums::Update _update,
  ...
  Float calc_prediction(const containers::Rescaled& _output_rescaled,
                        const containers::Rescaled& _input_rescaled,
                        const containers::Match& _match) const;
  ...
  bool match_is_greater(const containers::DataFrameView& _output,
                        const std::optional<containers::DataFrame>& _input,
                        const containers::Subfeatures& _subfeatures,
                        const containers::Match& _match) const;
  ...
  void try_discrete_input(const Float _old_intercept,
                          const containers::DataFrame& _input,
                          const std::vector<containers::Match>::iterator _begin,
                          const std::vector<containers::Match>::iterator _end,
                          std::vector<containers::Match>* _bins,
  ...
  void try_numerical_input(
      const Float _old_intercept, const containers::DataFrame& _peripheral,
      const std::vector<containers::Match>::iterator _begin,
      const std::vector<containers::Match>::iterator _end,
      std::vector<containers::Match>* _bins,
      std::vector<containers::CandidateSplit>* _candidates);
  ...
  void try_subfeatures(const Float _old_intercept,
                       const containers::Subfeatures& _subfeatures,
                       const std::vector<containers::Match>::iterator _begin,
                       const std::vector<containers::Match>::iterator _end,
                       std::vector<containers::Match>* _bins,
  ...
  /// conditions.
  void try_text(const std::shared_ptr<const std::vector<Int>>& _words,
                const size_t _num_column, const Float _old_intercept,
  ...
  void try_text_input(const Float _old_intercept,
                      const containers::DataFrame& _input,
                      const containers::Rescaled& _output_rescaled,
                      const containers::Rescaled& _input_rescaled,
                      const std::vector<containers::Match>::iterator _begin,
  ...
  void try_text_output(const Float _old_intercept,
                       const containers::DataFrameView& _output,
                       const containers::Rescaled& _output_rescaled,
                       const containers::Rescaled& _input_rescaled,
                       const std::vector<containers::Match>::iterator _begin,
 ...
 private:
  ...
  size_t calc_num_bins(
    ...
    return std::max(
        static_cast<size_t>(std::sqrt(static_cast<Float>(num_matches))),
  ...
  bool is_same_units(const enums::DataUsed _data_used) const {
    return (_data_used == enums::DataUsed::same_units_categorical ||
