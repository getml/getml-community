#ifndef RELMT_LOSSFUNCTIONS_SQUARELOSS_HPP_
#define RELMT_LOSSFUNCTIONS_SQUARELOSS_HPP_
...
class SquareLoss : public LossFunction {
 ...
 public:
  SquareLoss(const std::shared_ptr<const Hyperparameters>& _hyperparameters,
 ...
 public:
  ...
  /// case.
  void commit(const Float _old_intercept, const std::vector<Float>& _old_weight,
  ...
  Float evaluate_split(
      const Float _old_intercept, const std::vector<Float>& _old_weights,
...
#endif  // RELMT_LOSSFUNCTIONS_SQUARELOSS_HPP_
