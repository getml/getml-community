#ifndef RELMT_UTILS_CRITICALVALUES_HPP_
#define RELMT_UTILS_CRITICALVALUES_HPP_
...
class CriticalValues {
 ...
 public:
  ...
  static std::vector<Float> calc_discrete(
    ...
    return calc_discrete(_data_used, _num_column, _num_column, _input, _output,
                         _begin, _end, _comm);
  }
  ...
  static std::vector<Float> calc_numerical(
    ...
    return calc_numerical(_data_used, _num_column, _num_column, _input, _output,
                          _begin, _end, _comm);
  }
 ...
 private:
  ...
  static std::vector<Float> calc_numerical(const size_t _num_critical_values,
 ...
 private:
  ...
  static size_t calc_num_critical_values(Int _num_matches) {
    return std::max(
        static_cast<size_t>(std::sqrt(static_cast<Float>(_num_matches))),
...
#endif  // RELMT_UTILS_CRITICALVALUES_HPP_
