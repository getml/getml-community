#ifndef RELMT_UTILS_SAMPLER_HPP_
#define RELMT_UTILS_SAMPLER_HPP_
...
class Sampler {
 ...
 public:
  ...
  void calc_sampling_rate(const size_t _num_rows, const Float _sampling_factor,
                          multithreading::Communicator* _comm);

  /// Generates a new set of sample weights.
  std::shared_ptr<const std::vector<Float>> make_sample_weights(
...
#endif  // RELMT_UTILS_SAMPLER_HPP_
