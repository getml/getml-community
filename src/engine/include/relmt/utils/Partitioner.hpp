#ifndef RELMT_UTILS_PARTITIONER_HPP_
#define RELMT_UTILS_PARTITIONER_HPP_
...
struct Partitioner<enums::DataUsed::categorical_input> {
  ...
  static std::vector<containers::Match>::iterator partition(
    ...
    const auto partition_function = [&_split, &_input](containers::Match m) {
  ...
  static bool is_greater(const containers::Split& _split,
    ...
    const auto it =
        std::find(_split.categories_used_begin_, _split.categories_used_end_,
...
struct Partitioner<enums::DataUsed::categorical_output> {
  ...
  static std::vector<containers::Match>::iterator partition(
      ...
      const std::vector<containers::Match>::iterator _begin,
      const std::vector<containers::Match>::iterator _end) {
    const auto partition_function = [_split, &_output](containers::Match m) {
...
struct Partitioner<enums::DataUsed::discrete_input_is_nan> {
  static std::vector<containers::Match>::iterator partition(
      const size_t _num_column, const containers::DataFrame& _input,
      const std::vector<containers::Match>::iterator _begin,
      const std::vector<containers::Match>::iterator _end) {
    assert_true(_end >= _begin);

    return std::partition(_begin, _end,
                          [_num_column, &_input](containers::Match m) {
  ...
  static bool is_greater(const size_t _num_column,
                         const containers::DataFrame& _input,
                         const containers::Match& _match) {
...
struct Partitioner<enums::DataUsed::discrete_output_is_nan> {
  static std::vector<containers::Match>::iterator partition(
      const size_t _num_column, const containers::DataFrameView& _output,
      const std::vector<containers::Match>::iterator _begin,
      const std::vector<containers::Match>::iterator _end) {
    assert_true(_end >= _begin);

    return std::partition(_begin, _end,
                          [_num_column, &_output](containers::Match m) {
...
struct Partitioner<enums::DataUsed::same_units_categorical> {
  ...
  static std::vector<containers::Match>::iterator partition(
      ...
      const std::vector<containers::Match>::iterator _begin,
      const std::vector<containers::Match>::iterator _end) {
    const auto partition_function = [_split, &_input,
...
struct Partitioner<enums::DataUsed::same_units_discrete> {
  ...
  static bool is_greater(const containers::Split& _split,
    ...
    const auto diff = _output.discrete(_match.ix_output, _split.column_) -
...
struct Partitioner<enums::DataUsed::same_units_discrete_is_nan> {
  ...
  static std::vector<containers::Match>::iterator partition(
      ...
      const std::vector<containers::Match>::iterator _begin,
      const std::vector<containers::Match>::iterator _end) {
    const auto partition_function = [_input_col, _output_col, &_input,
                                     &_output](containers::Match m) {
...
struct Partitioner<enums::DataUsed::same_units_numerical> {
  ...
  static bool is_greater(const containers::Split& _split,
    ...
    const auto diff = _output.numerical(_match.ix_output, _split.column_) -
...
struct Partitioner<enums::DataUsed::text_input> {
  ...
  static bool is_greater(const containers::Split& _split,
    ...
    const auto it = std::find_if(_split.categories_used_begin_,
                                 _split.categories_used_end_, in_range);
...
struct Partitioner<enums::DataUsed::text_output> {
  ...
  static bool is_greater(const containers::Split& _split,
    ...
    const auto range = _output.df().word_indices_[j]->range(_output.rows()[i]);
...
struct Partitioner<enums::DataUsed::time_stamps_window> {
  ...
  static std::vector<containers::Match>::iterator partition(
      ...
      const std::vector<containers::Match>::iterator _begin,
      const std::vector<containers::Match>::iterator _end) {
    const auto partition_function = [_split, _lag, &_input,
                                     &_output](containers::Match m) {
...
#endif  // RELMT_UTILS_PARTITIONER_HPP_
