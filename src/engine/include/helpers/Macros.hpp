...
class Macros {
 public:
  ...
  static std::string get_param(const std::string& _splitted,
 ...
 public:
  ...
  static std::string fast_prop_feature() { return "$GETML_FAST_PROP_FEATURE"; }
  ...
  static std::string make_colname(const std::string& _tname,
  ...
  static std::string staging_table_num() { return "$GETML_STAGING_TABLE_NUM"; }
