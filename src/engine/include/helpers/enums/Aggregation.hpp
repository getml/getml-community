...
using Aggregation = fct::Literal<
    "AVG", "AVG TIME BETWEEN", "COUNT", "COUNT ABOVE MEAN", "COUNT BELOW MEAN",
    "COUNT DISTINCT", "COUNT DISTINCT OVER COUNT", "COUNT MINUS COUNT DISTINCT",
    "EWMA_1S", "EWMA_1M", "EWMA_1H", "EWMA_1D", "EWMA_7D", "EWMA_30D",
    "EWMA_90D", "EWMA_365D", "EWMA_TREND_1S", "EWMA_TREND_1M", "EWMA_TREND_1H",
