#ifndef RELBOOST_AGGREGATIONS_AGGREGATIONINDEX_HPP_
#define RELBOOST_AGGREGATIONS_AGGREGATIONINDEX_HPP_
...
class AggregationIndex {
 public:
  AggregationIndex(const containers::DataFrameView& _input_table,
 ...
 public:
  ...
  Int transform_ix_agg(const Int _ix_agg,
 ...
 private:
  ...
  bool time_stamp_output_in_range(const Float _time_stamp_input,
...
#endif  // RELBOOST_AGGREGATIONS_AGGREGATIONINDEX_HPP_
