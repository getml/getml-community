...
class LossFunctionImpl {
 ...
 public:
  ...
  std::pair<Float, std::array<Float, 3>> calc_pair(
    ...
    switch (_agg) {
      ...
      case enums::Aggregation::sum:
        return calc_pair_non_null(_update, _old_weight, _indices_current, _eta1,
                                  _eta1_old, _eta2, _eta2_old, _yhat_committed,
                                  _sufficient_stats_non_null, _comm);

      case enums::Aggregation::avg_first_null:
        return calc_pair_avg_null(_agg, _update, _old_weight, _indices_current,
                                  _eta1, _eta1_old, _eta2, _eta2_old,
                                  _yhat_committed, _sufficient_stats_first_null,
                                  _comm);
      ...
      case enums::Aggregation::avg_second_null:
        return calc_pair_avg_null(_agg, _update, _old_weight, _indices_current,
                                  _eta1, _eta1_old, _eta2, _eta2_old,
                                  _yhat_committed,
                                  _sufficient_stats_second_null, _comm);
    ...
    switch (_agg) {
      ...
      case enums::Aggregation::sum:
        return calc_sufficient_stats_non_null(
            _update, _old_weight, _indices_current, _eta1, _eta1_old, _eta2,
            _eta2_old, _yhat_committed, _sufficient_stats_non_null);
        break;

      case enums::Aggregation::avg_first_null:
        calc_sufficient_stats_avg_null(
            _update, _old_weight, _indices_current, _eta1, _eta1_old, _eta2,
            _eta2_old, _yhat_committed, _sufficient_stats_first_null);
        break;

      case enums::Aggregation::avg_second_null:
        calc_sufficient_stats_avg_null(
            _update, _old_weight, _indices_current, _eta1, _eta1_old, _eta2,
            _eta2_old, _yhat_committed, _sufficient_stats_second_null);
        break;
  ...
  void calc_yhat(const enums::Aggregation _agg, const Float _old_weight,
                 ...
                 const std::vector<Float>& _yhat_committed,
                 std::vector<Float>* _yhat) const {
    if (_agg == enums::Aggregation::avg || _agg == enums::Aggregation::sum) {
      calc_yhat(_old_weight, _new_weights, _indices, _eta1, _eta2,
                _yhat_committed, _yhat);
    } else if (_agg == enums::Aggregation::avg_first_null ||
               _agg == enums::Aggregation::avg_second_null) {
      // _eta2 serves the role of fixed weights.
      calc_yhat_avg_null(_old_weight, _new_weights, _indices, _eta1, _eta2,
                         _yhat);
    } else {
 ...
 private:
  ...
  void calc_yhat_avg_null(const Float _old_weight,
                          const std::array<Float, 3>& _new_weights,
                          const std::vector<size_t>& _indices,
