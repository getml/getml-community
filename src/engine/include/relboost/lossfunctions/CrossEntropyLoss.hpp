  ...
  CrossEntropyLoss(
      ...
      : comm_(nullptr),
        ...
        impl_(LossFunctionImpl(
            g_, h_, hyperparameters_, sample_index_, sample_weights_, sum_g_,
            sum_h_, sum_h_yhat_committed_, sum_sample_weights_, targets_)) {
 ...
 public:
  ...
  void calc_etas(const enums::Aggregation _agg, const enums::Update _update,
    ...
    impl_.calc_sufficient_stats(
        _agg, _update, _old_weight, _indices_current, _eta1, _eta1_old, _eta2,
        _eta2_old, yhat_committed_, &sufficient_stats_non_null_,
        &sufficient_stats_first_null_, &sufficient_stats_second_null_);
  }
  ...
  std::pair<Float, std::array<Float, 3>> calc_pair(
    ...
    return impl_.calc_pair(
        _agg, _revert, _update, _old_weight, _indices_current, _eta1, _eta1_old,
        _eta2, _eta2_old, yhat_committed_, &sufficient_stats_non_null_,
        &sufficient_stats_first_null_, &sufficient_stats_second_null_, &comm());
  }
  ...
  std::vector<std::pair<Float, std::array<Float, 3>>> calc_pairs(
    ...
    const auto p =
        impl_.calc_pair(_revert, _update, _begin, _split_begin, _split_end,
                        _end, &loss_old_, &sufficient_stats_xgboost_, &comm());
  ...
  void calc_yhat(const enums::Aggregation _agg, const Float _old_weight,
                 ...
                 const std::vector<Float>& _eta2,
                 const std::vector<Float>& _eta2_old) final {
    impl_.calc_yhat(_agg, _old_weight, _new_weights, _indices, _eta1, _eta2,
  ...
  void commit(const Float _old_intercept, const Float _old_weight,
  ...
  Float evaluate_split(const Float _old_intercept, const Float _old_weight,
    ...
    return loss_committed_ - calc_loss(_weights) +
           impl_.calc_regularization_reduction(_old_intercept, _old_weight,
                                               _weights);
  }
