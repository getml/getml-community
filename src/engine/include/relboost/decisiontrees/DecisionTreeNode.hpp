...
class DecisionTreeNode {
 ...
 public:
  DecisionTreeNode(
      ...
      const Float _weight, multithreading::Communicator* _comm);
 ...
 private:
  ...
  const std::shared_ptr<const helpers::Schema> input_;
  ...
  const std::shared_ptr<const helpers::Schema> output_;
