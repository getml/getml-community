#ifndef SQL_POSTGRESQLGENERATOR_HPP_
#define SQL_POSTGRESQLGENERATOR_HPP_
...
class PostgreSQLGenerator : public SQLDialectGenerator {
 public:
  explicit PostgreSQLGenerator(const TranspilationParams& _params)
      : params_(_params) {}
 ...
 private:
  ...
  std::string create_index(const std::string& _table_name,
...
#endif  // SQL_POSTGRESQLGENERATOR_HPP_
