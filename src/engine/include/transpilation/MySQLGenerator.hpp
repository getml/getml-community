#ifndef SQL_MYSQLGENERATOR_HPP_
#define SQL_MYSQLGENERATOR_HPP_
...
class MySQLGenerator : public SQLDialectGenerator {
 ...
 public:
  ...
  /// Removes the Macros from the colname and replaces it with proper MySQL
  /// code.
  ...
  /// Transpiles the features in MySQL code. This
 ...
 private:
  ...
  /// Edits the pre- and postfix to account for the way MySQL deals with
  /// time intervals.
