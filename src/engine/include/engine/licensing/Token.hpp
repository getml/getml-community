...
struct Token {
  Token(const Int _cores, const bool _currently_active, const Int _expires_in,
        const std::string& _function_set_id, const Int _mem,
        const std::string& _msg_body, const std::string& _msg_title,
