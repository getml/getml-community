...
class ColumnViewIterator {
 public:
  ...
  /// Add value
  friend inline ColumnViewIterator<T> operator+(const ColumnViewIterator<T>& _a,
                                                const difference_type _j) {
  ...
  friend inline difference_type operator-(const ColumnViewIterator<T>& _a,
                                          const ColumnViewIterator<T>& _b) {
