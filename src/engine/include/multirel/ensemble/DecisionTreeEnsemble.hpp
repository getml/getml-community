...
#include "multirel/ensemble/DecisionTreeEnsembleImpl.hpp"
...
class DecisionTreeEnsemble {
 ...
 public:
  ...
  /// Trivial setter
  void set_comm(multithreading::Communicator *_comm) { impl().comm_ = _comm; }
  ...
  inline std::string to_json() const { return JSON::stringify(to_json_obj()); }
 ...
 private:
  ...
  DecisionTreeEnsemble from_json_obj(const Poco::JSON::Object &_json_obj) const;
