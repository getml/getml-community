...
void test25_snowflake_model4( std::filesystem::path _test_path )
{
    // ------------------------------------------------------------------------

    std::cout << "Test 25 | snowflake model, SUM of SUM with categorical\t";
    ...
    _test_path.append( "relboost" ).append( "test25" ).append( "schema.json" );
