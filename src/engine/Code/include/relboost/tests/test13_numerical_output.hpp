...
void test13_numerical_output()
{
    // ------------------------------------------------------------------------

    std::cout << std::endl
              << "Test 13 (numerical output): " << std::endl
              << std::endl;
    ...
    const auto population_json = load_json( "../../tests/relboost/test13/schema.json" );
    ...
    const auto hyperparameters_json =
        load_json( "../../tests/relboost/test13/hyperparameters.json" );
    ...
    model.save( "../../tests/relboost/test13/Model.json" );

    // ------------------------------------------------------------------------
    // Express as SQL code.

    std::ofstream sql( "../../tests/relboost/test13/Model.sql" );
    sql << model.to_sql();
    sql.close();
