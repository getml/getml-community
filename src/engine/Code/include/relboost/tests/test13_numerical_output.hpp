...
void test13_numerical_output()
{
    ...
    const auto population_json = load_json( "../../tests/test13/schema.json" );
    ...
    const auto hyperparameters_json =
        load_json( "../../tests/test13/hyperparameters.json" );
    ...
    model.save( "../../tests/test13/Model.json" );

    // ------------------------------------------------------------------------
    // Express as SQL code.

    std::ofstream sql( "../../tests/test13/Model.sql" );
    sql << model.to_sql();
    sql.close();
