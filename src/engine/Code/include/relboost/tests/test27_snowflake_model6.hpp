...
void test27_snowflake_model6( std::filesystem::path _test_path )
{
    // ------------------------------------------------------------------------

    std::cout << "Test 27 | snowflake model, SUM of AVG with categorical\t";
    ...
    _test_path.append( "relboost" ).append( "test27" ).append( "schema.json" );
