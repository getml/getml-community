...
void test10_same_units_categorical( std::filesystem::path _test_path )
{
    // ------------------------------------------------------------------------

    std::cout << "Test 10 | same units categorical\t\t\t";
    ...
    _test_path.append( "relboost" ).append( "test10" ).append( "schema.json" );
