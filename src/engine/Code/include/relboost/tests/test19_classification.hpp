...
void test19_classification()
{
    ...
    const auto population_json = load_json( "../../tests/relboost/test19/schema.json" );
    ...
    const auto hyperparameters_json =
        load_json( "../../tests/relboost/test19/hyperparameters.json" );
    ...
    model.save( "../../tests/relboost/test19/Model.json" );

    // ------------------------------------------------------------------------
    // Express as SQL code.

    std::ofstream sql( "../../tests/relboost/test19/Model.sql" );
    sql << model.to_sql();
    sql.close();
