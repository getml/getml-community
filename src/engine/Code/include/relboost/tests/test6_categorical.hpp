...
void test6_categorical( std::filesystem::path _test_path )
{
    // ------------------------------------------------------------------------

    std::cout << "Test 6 | AVG aggregation with categorical variables\t";
    ...
    _test_path.append( "relboost" ).append( "test6" ).append( "schema.json" );
