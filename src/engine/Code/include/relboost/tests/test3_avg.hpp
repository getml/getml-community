...
void test3_avg( std::filesystem::path _test_path )
{
    // ------------------------------------------------------------------------

    std::cout << "Test 3 | AVG aggregation with NULL value\t\t";
    ...
    _test_path.append( "relboost" ).append( "test3" ).append( "schema.json" );
