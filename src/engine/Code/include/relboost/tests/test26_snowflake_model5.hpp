...
void test26_snowflake_model5( std::filesystem::path _test_path )
{
    // ------------------------------------------------------------------------

    std::cout << "Test 26 | snowflake model, AVG of SUM with multiple\t|"
              << std::endl
              << "        | categorical\t\t\t\t\t";
    ...
    _test_path.append( "relboost" ).append( "test26" ).append( "schema.json" );
