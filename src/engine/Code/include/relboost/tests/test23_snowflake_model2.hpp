...
void test23_snowflake_model2( std::filesystem::path _test_path )
{
    // ------------------------------------------------------------------------

    std::cout << "Test 23 | snowflake model, AVG of SUM\t\t\t";
    ...
    _test_path.append( "relboost" ).append( "test23" ).append( "schema.json" );
