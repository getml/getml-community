...
void test21_time_windows()
{
    // ------------------------------------------------------------------------

    std::cout << std::endl
              << "Test 21 (time windows): " << std::endl
              << std::endl;
    ...
    const auto population_json =
        load_json( "../../tests/relboost/test21/schema.json" );
    ...
    const auto hyperparameters_json =
        load_json( "../../tests/relboost/test21/hyperparameters.json" );
    ...
    model.save( "../../tests/relboost/test21/Model.json" );

    // ------------------------------------------------------------------------
    // Express as SQL code.

    std::ofstream sql( "../../tests/relboost/test21/Model.sql" );
    sql << model.to_sql();
    sql.close();
