...
void test9_discrete()
{
    ...
    std::cout << std::endl << "Test 9 (discrete): " << std::endl << std::endl;
    ...
    const auto population_json =
        load_json( "../../tests/multirel/test9/schema.json" );
    ...
    const auto hyperparameters_json =
        load_json( "../../tests/multirel/test9/hyperparameters.json" );
    ...
    model.save( "../../tests/multirel/test9/Model.json" );

    // ------------------------------------------------------------------------
    // Express as SQL code.

    std::ofstream sql( "../../tests/multirel/test9/Model.sql" );
    sql << model.to_sql();
    sql.close();
