...
void test4_max()
{
    ...
    std::cout << std::endl
              << "Test 4 (MAX aggregation): " << std::endl
              << std::endl;
    ...
    const auto population_json =
        load_json( "../../tests/multirel/test4/schema.json" );
    ...
    const auto hyperparameters_json =
        load_json( "../../tests/multirel/test4/hyperparameters.json" );
    ...
    model.save( "../../tests/multirel/test4/Model.json" );

    // ------------------------------------------------------------------------
    // Express as SQL code.

    std::ofstream sql( "../../tests/multirel/test4/Model.sql" );
    sql << model.to_sql();
    sql.close();
