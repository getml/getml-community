...
void test3_sum()
{
    ...
    const auto population_json =
        load_json( "../../tests/multirel/test3/schema.json" );
    ...
    const auto hyperparameters_json =
        load_json( "../../tests/multirel/test3/hyperparameters.json" );
    ...
    model.save( "../../tests/multirel/test3/Model.json" );

    // ------------------------------------------------------------------------
    // Express as SQL code.

    std::ofstream sql( "../../tests/multirel/test3/Model.sql" );
    sql << model.to_sql();
    sql.close();
