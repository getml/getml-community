...
void test16_nan_values_numerical()
{
    ...
    const auto population_json =
        load_json( "../../tests/multirel/test16/schema.json" );
    ...
    const auto hyperparameters_json =
        load_json( "../../tests/multirel/test16/hyperparameters.json" );
    ...
    model.save( "../../tests/multirel/test16/Model.json" );

    // ------------------------------------------------------------------------
    // Express as SQL code.

    std::ofstream sql( "../../tests/multirel/test16/Model.sql" );
    sql << model.to_sql();
    sql.close();
