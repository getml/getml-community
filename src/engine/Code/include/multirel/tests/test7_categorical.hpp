...
void test7_categorical()
{
    ...
    const auto population_json =
        load_json( "../../tests/multirel/test7/schema.json" );
    ...
    const auto hyperparameters_json =
        load_json( "../../tests/multirel/test7/hyperparameters.json" );
    ...
    model.save( "../../tests/multirel/test7/Model.json" );

    // ------------------------------------------------------------------------
    // Express as SQL code.

    std::ofstream sql( "../../tests/multirel/test7/Model.sql" );
    sql << model.to_sql();
    sql.close();
