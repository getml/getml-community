...
void test18_upper_time_stamps()
{
    ...
    const auto population_json =
        load_json( "../../tests/multirel/test18/schema.json" );
    ...
    const auto hyperparameters_json =
        load_json( "../../tests/multirel/test18/hyperparameters.json" );
    ...
    model.save( "../../tests/multirel/test18/Model.json" );

    // ------------------------------------------------------------------------
    // Express as SQL code.

    std::ofstream sql( "../../tests/multirel/test18/Model.sql" );
    sql << model.to_sql();
    sql.close();
