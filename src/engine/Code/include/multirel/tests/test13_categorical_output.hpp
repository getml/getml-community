...
void test13_categorical_output()
{
    ...
    const auto population_json =
        load_json( "../../tests/multirel/test13/schema.json" );
    ...
    const auto hyperparameters_json =
        load_json( "../../tests/multirel/test13/hyperparameters.json" );
    ...
    model.save( "../../tests/multirel/test13/Model.json" );

    // ------------------------------------------------------------------------
    // Express as SQL code.

    std::ofstream sql( "../../tests/multirel/test13/Model.sql" );
    sql << model.to_sql();
    sql.close();
