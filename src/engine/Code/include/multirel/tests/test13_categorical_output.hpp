...
void test13_categorical_output( std::filesystem::path _test_path )
{
    // ------------------------------------------------------------------------

    std::cout << "Test 13 | categorical output\t\t\t";
    ...
    _test_path.append( "multirel" ).append( "test13" ).append( "schema.json" );
