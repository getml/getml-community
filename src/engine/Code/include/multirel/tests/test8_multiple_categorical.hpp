...
void test8_multiple_categorical()
{
    ...
    const auto population_json =
        load_json( "../../tests/multirel/test8/schema.json" );
    ...
    const auto hyperparameters_json =
        load_json( "../../tests/multirel/test8/hyperparameters.json" );
    ...
    model.save( "../../tests/multirel/test8/Model.json" );

    // ------------------------------------------------------------------------
    // Express as SQL code.

    std::ofstream sql( "../../tests/multirel/test8/Model.sql" );
    sql << model.to_sql();
    sql.close();
