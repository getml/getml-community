...
void test2_avg()
{
    ...
    const auto population_json =
        load_json( "../../tests/multirel/test2/schema.json" );
    ...
    const auto hyperparameters_json =
        load_json( "../../tests/multirel/test2/hyperparameters.json" );
    ...
    model.save( "../../tests/multirel/test2/Model.json" );

    // ------------------------------------------------------------------------
    // Express as SQL code.

    std::ofstream sql( "../../tests/multirel/test2/Model.sql" );
    sql << model.to_sql();
    sql.close();
