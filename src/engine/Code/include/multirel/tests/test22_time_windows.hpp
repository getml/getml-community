...
void test22_time_windows()
{
    ...
    const auto population_json =
        load_json( "../../tests/multirel/test22/schema.json" );
    ...
    const auto hyperparameters_json =
        load_json( "../../tests/multirel/test22/hyperparameters.json" );
    ...
    model.save( "../../tests/multirel/test22/Model.json" );

    // ------------------------------------------------------------------------
    // Express as SQL code.

    std::ofstream sql( "../../tests/multirel/test22/Model.sql" );
    sql << model.to_sql();
    sql.close();
