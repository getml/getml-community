...
void test12_same_units_discrete()
{
    ...
    const auto population_json =
        load_json( "../../tests/multirel/test12/schema.json" );
    ...
    const auto hyperparameters_json =
        load_json( "../../tests/multirel/test12/hyperparameters.json" );
    ...
    model.save( "../../tests/multirel/test12/Model.json" );

    // ------------------------------------------------------------------------
    // Express as SQL code.

    std::ofstream sql( "../../tests/multirel/test12/Model.sql" );
    sql << model.to_sql();
    sql.close();
