...
class MemoryMappedEncoding
{
   ...
   public:
    ...
    void append(
        const MemoryMappedEncoding& _other, bool _include_subencoding = false );
    ...
    MemoryMappedEncoding& operator=( const MemoryMappedEncoding& _other ) =
        delete;
   ...
   private:
    ...
    Int insert(
        const strings::String& _val, const std::optional<size_t>& _opt );
