...
void test4_categorical( const std::filesystem::path _test_path )
{
    // ------------------------------------------------------------------------

    auto test4_path = _test_path;

    test4_path.append( "relmt" ).append( "test4" );

    // ------------------------------------------------------------------------

    std::cout << "Test 4 | COUNT aggregation, categorical\t\t\t\t";
    ...
    auto hyperparameters_path = test4_path;
