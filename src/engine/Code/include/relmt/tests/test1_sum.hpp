...
void test1_sum( const std::filesystem::path _test_path )
{
    // ------------------------------------------------------------------------

    auto test1_path = _test_path;

    test1_path.append( "relmt" ).append( "test1" );

    // ------------------------------------------------------------------------

    std::cout << "Test 1 | SUM aggregation\t\t\t\t";
    ...
    auto hyperparameters_path = test1_path;
