...
void test2_count( const std::filesystem::path _test_path )
{
    // ------------------------------------------------------------------------

    auto test2_path = _test_path;

    test2_path.append( "relmt" ).append( "test2" );

    // ------------------------------------------------------------------------

    std::cout << "Test 2 | COUNT aggregation\t\t\t\t";
    ...
    auto hyperparameters_path = test2_path;
