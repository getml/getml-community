...
void test14_categorical_output()
{
    // ------------------------------------------------------------------------

    std::cout << std::endl
              << "Test 14 (categorical output): " << std::endl
              << std::endl;
    ...
    const auto population_json = load_json( "../../tests/autosql/test14/schema.json" );
    ...
    const auto hyperparameters_json =
        load_json( "../../tests/autosql/test14/hyperparameters.json" );
    ...
    model.save( "../../tests/autosql/test14/Model.json" );

    // ------------------------------------------------------------------------
    // Express as SQL code.

    std::ofstream sql( "../../tests/autosql/test14/Model.sql" );
    sql << model.to_sql();
    sql.close();
