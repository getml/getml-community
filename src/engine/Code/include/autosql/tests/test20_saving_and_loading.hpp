...
void test20_saving_and_loading()
{
    ...
    const auto population_json = load_json( "../../tests/autosql/test20/schema.json" );
    ...
    const auto model_json = load_json( "../../tests/autosql/test20/Model.json" );
    ...
    const auto model2_json = load_json( "../../tests/autosql/test20/Model.json" );
