...
void test10_same_units_categorical()
{
    ...
    const auto population_json = load_json( "../../tests/autosql/test10/schema.json" );
    ...
    const auto hyperparameters_json =
        load_json( "../../tests/autosql/test10/hyperparameters.json" );
    ...
    model.save( "../../tests/autosql/test10/Model.json" );

    // ------------------------------------------------------------------------
    // Express as SQL code.

    std::ofstream sql( "../../tests/autosql/test10/Model.sql" );
    sql << model.to_sql();
    sql.close();
