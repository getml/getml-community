...
void test9_discrete()
{
    ...
    const auto population_json = load_json( "../../tests/autosql/test9/schema.json" );
    ...
    const auto hyperparameters_json =
        load_json( "../../tests/autosql/test9/hyperparameters.json" );
    ...
    model.save( "../../tests/autosql/test9/Model.json" );

    // ------------------------------------------------------------------------
    // Express as SQL code.

    std::ofstream sql( "../../tests/autosql/test9/Model.sql" );
    sql << model.to_sql();
    sql.close();
