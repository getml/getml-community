...
void test19_classification()
{
    ...
    const auto population_json = load_json( "../../tests/autosql/test19/schema.json" );
    ...
    const auto hyperparameters_json =
        load_json( "../../tests/autosql/test19/hyperparameters.json" );
    ...
    model.save( "../../tests/autosql/test19/Model.json" );

    // ------------------------------------------------------------------------
    // Express as SQL code.

    std::ofstream sql( "../../tests/autosql/test19/Model.sql" );
    sql << model.to_sql();
    sql.close();
