...
class OptimizationCriterionImpl
{
   public:
    ...
    /// processes
    std::deque<std::vector<Float>> reduce_sufficient_statistics_stored()
        const;
    ...
    /// Trivial getter
    inline std::vector<Float>& values_stored()
    {
   ...
   private:
    ...
    /// Trivial (private) accessor
    inline std::deque<std::vector<Float>>&
    ...
    /// Trivial (private) accessor
    inline const std::deque<std::vector<Float>>&
