#ifndef METRICS_ROCCURVE_HPP_
#define METRICS_ROCCURVE_HPP_

namespace metrics
{
// ----------------------------------------------------------------------------

class ROCCurve : public Metric
{
   public:
    ROCCurve() {}

    ROCCurve( multithreading::Communicator* _comm ) : impl_( _comm ) {}
