...
class SapHana : public Connector
{
   ...
   public:
    SapHana(
        ...
        : default_schema_( jsonutils::JSON::get_value<std::string>(
              _obj, "default_schema_" ) ),
          host_( jsonutils::JSON::get_value<std::string>( _obj, "host_" ) ),
          password_( _password ),
          ping_interval_(
              jsonutils::JSON::get_value<Int>( _obj, "ping_interval_" ) ),
    ...
    SapHana(
        const std::string& _default_schema,
        const std::string& _host,
        const std::string& _password,
        const Int _ping_interval,
        const Int _port,
        const std::vector<std::string>& _time_formats,
