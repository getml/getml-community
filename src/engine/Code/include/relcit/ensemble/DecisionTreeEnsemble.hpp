#ifndef RELBOOSTXX_ENSEMBLE_DECISIONTREEENSEMBLE_HPP_
#define RELBOOSTXX_ENSEMBLE_DECISIONTREEENSEMBLE_HPP_
...
class DecisionTreeEnsemble
{
   ...
   public:
    typedef relcit::containers::DataFrame DataFrameType;
    typedef relcit::containers::DataFrameView DataFrameViewType;
    typedef relcit::containers::Features FeaturesType;
    typedef relcit::Hyperparameters HypType;
    typedef relcit::containers::Placeholder PlaceholderType;
...
#endif  // RELBOOSTXX_ENSEMBLE_DECISIONTREEENSEMBLE_HPP_
