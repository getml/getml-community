#ifndef RELBOOSTXX_ENSEMBLE_THREADUTILS_HPP_
#define RELBOOSTXX_ENSEMBLE_THREADUTILS_HPP_
...
class Threadutils
{
   ...
   private:
    ...
    /// Fits the relcit ensemble as a feature learner.
...
#endif  // RELBOOSTXX_ENSEMBLE_THREADUTILS_HPP_
