...
void test6_snowflake_model( std::filesystem::path _test_path )
{
    ...
    test6_path.append( "relcit" ).append( "test6" );
    ...
    const auto numerical_peripheral2_col = relcit::containers::Column<double>(
    ...
    const auto time_stamp2_peripheral2_col = relcit::containers::Column<double>(
        time_stamp2_peripheral2.data(),
        "time_stamp2",
        time_stamp2_peripheral2.size() );

    const auto peripheral2_df = relcit::containers::DataFrame(
        {},
        {},
    ...
    const auto numerical_peripheral1_col = relcit::containers::Column<double>(
    ...
    const auto time_stamp1_peripheral1_col = relcit::containers::Column<double>(
    ...
    const auto time_stamp2_peripheral1_col = relcit::containers::Column<double>(
        time_stamp2_peripheral1.data(),
        "time_stamp2",
        time_stamp2_peripheral1.size() );

    const auto peripheral1_df = relcit::containers::DataFrame(
        {},
        {},
    ...
    const auto hyperparameters =
        std::make_shared<relcit::Hyperparameters>( *hyperparameters_json );
