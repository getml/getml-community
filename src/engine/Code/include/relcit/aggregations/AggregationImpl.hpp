#ifndef RELBOOSTXX_AGGREGATIONS_AGGREGATIONIMPL_HPP_
#define RELBOOSTXX_AGGREGATIONS_AGGREGATIONIMPL_HPP_
...
#endif  // RELBOOSTXX_AGGREGATIONS_AGGREGATIONIMPL_HPP_
