#ifndef RELBOOSTXX_AGGREGATIONS_AGGREGATIONINDEX_HPP_
#define RELBOOSTXX_AGGREGATIONS_AGGREGATIONINDEX_HPP_
...
#endif  // RELBOOSTXX_AGGREGATIONS_AGGREGATIONINDEX_HPP_
