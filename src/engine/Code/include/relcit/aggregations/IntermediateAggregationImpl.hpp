#ifndef RELBOOSTXX_AGGREGATIONS_INTERMEDIATEAGGREGATIONIMPL_HPP_
#define RELBOOSTXX_AGGREGATIONS_INTERMEDIATEAGGREGATIONIMPL_HPP_
...
class IntermediateAggregationImpl
{
   ...
   private:
    ...
    void update_etas_divide_by_count(
        const std::vector<size_t>& _indices_current,
        const std::vector<Float>& _eta1_input,
        const std::vector<Float>& _eta1_input_old,
        const std::vector<Float>& _eta2_input,
...
#endif  // RELBOOSTXX_AGGREGATIONS_INTERMEDIATEAGGREGATIONIMPL_HPP_
