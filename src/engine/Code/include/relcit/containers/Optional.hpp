#ifndef RELBOOSTXX_CONTAINERS_OPTIONAL_HPP_
#define RELBOOSTXX_CONTAINERS_OPTIONAL_HPP_
...
class Optional
{
   public:
    ...
    void reset() { thisptr().reset(); }

    void reset( T* _ptr ) { thisptr().reset( _ptr ); }
...
#endif  // RELBOOSTXX_CONTAINERS_OPTIONAL_HPP_
