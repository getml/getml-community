#ifndef RELBOOSTXX_CONTAINERS_RESCALED_HPP_
#define RELBOOSTXX_CONTAINERS_RESCALED_HPP_
...
class Rescaled
{
   ...
   public:
    Rescaled(
        const std::shared_ptr<std::vector<Float>>& _data,
        const size_t _nrows,
        const size_t _ncols,
...
#endif  // RELBOOSTXX_CONTAINERS_RESCALED_HPP_
