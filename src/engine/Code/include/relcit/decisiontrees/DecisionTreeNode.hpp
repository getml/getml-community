#ifndef RELBOOSTXX_DECISIONTREES_DECISIONTREENODE_HPP_
#define RELBOOSTXX_DECISIONTREES_DECISIONTREENODE_HPP_
...
class DecisionTreeNode
{
   ...
   public:
    ...
    /// update rates are implemented in relcit.
   ...
   private:
    ...
    /// Hyperparameters used to train the relcit model
...
#endif  // RELBOOSTXX_DECISIONTREES_DECISIONTREENODE_HPP_
