#ifndef RELBOOSTXX_LOSSFUNCTIONS_LOSSFUNCTIONIMPL_HPP_
#define RELBOOSTXX_LOSSFUNCTIONS_LOSSFUNCTIONIMPL_HPP_
...
class LossFunctionImpl
{
   ...
   private:
    ...
    size_t calc_dim(
        const size_t _ncolsplus1, const enums::Update _update ) const
    {
    ...
    void update_Hfwf(
        const size_t _ncolsplus1,
        const Float _h_sample_weights,
        const Float _w_fixed,
        const Float* _eta1,
        const Float* _eta1_old,
        const Float* _eta2,
        const Float* _eta2_old,
        Float* _Hfwf ) const
    {
        ...
        for ( size_t i = 0; i < _ncolsplus1; ++i )
            {
                ...
                _Hfwf[i + _ncolsplus1 + 1] -=
                    _w_fixed * d_eta * _h_sample_weights;
            }
    }
...
#endif  // RELBOOSTXX_LOSSFUNCTIONS_LOSSFUNCTIONIMPL_HPP_
