#ifndef RELBOOSTXX_LOSSFUNCTIONS_CROSSENTROPYLOSS_HPP_
#define RELBOOSTXX_LOSSFUNCTIONS_CROSSENTROPYLOSS_HPP_
...
class CrossEntropyLoss : public LossFunction
{
   ...
   private:
    ...
    /// The sufficient statistics needed to apply the relcit formula
...
#endif  // RELBOOSTXX_LOSSFUNCTIONS_CROSSENTROPYLOSS_HPP_
