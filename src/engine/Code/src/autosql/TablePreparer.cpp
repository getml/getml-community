    ...
    TableHolder &_table_holder )
{
    ...
    const auto it = std::find_if(
        ...
        [join_key_name]( const containers::Matrix<Int> &jk ) {
    ...
    TableHolder &_table_holder )
{
    ...
    const auto it = std::find_if(
        ...
        [time_stamps_name]( const containers::Matrix<Float> &ts ) {
...
Int TablePreparer::identify_peripheral(
    const size_t _i,
    const Placeholder &_placeholder_population,
    const std::vector<std::string> &_placeholder_peripheral )
{
    ...
    TableHolder &_table_holder )
{
    ...
    const auto it = std::find_if(
        ...
        [other_join_key_name]( containers::Matrix<Int> &jk ) {
    ...
    TableHolder &_table_holder )
{
    ...
    const auto it = std::find_if(
        ...
        [other_time_stamps_name]( containers::Matrix<Float> &ts ) {
    ...
    TableHolder &_table_holder )
{
    ...
    const auto it = std::find_if(
        _table_holder.peripheral_tables[_i].time_stamps_all().begin(),
        _table_holder.peripheral_tables[_i].time_stamps_all().end(),
        [upper_time_stamps_name]( containers::Matrix<Float> &ts ) {
