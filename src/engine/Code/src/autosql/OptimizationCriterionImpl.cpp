    ...
    AUTOSQL_INT _sufficient_statistics_ncols )
{
    ...
    containers::Matrix<AUTOSQL_FLOAT> extension(
        _storage_size_extension, _sufficient_statistics_ncols + 2 );

    sufficient_statistics_stored_.append( extension );

    extension = containers::Matrix<AUTOSQL_FLOAT>( _storage_size_extension, 1 );
    ...
    AUTOSQL_INT _storage_size, AUTOSQL_INT _sufficient_statistics_ncols )
{
    ...
    values_stored_ = containers::Matrix<AUTOSQL_FLOAT>( _storage_size, 1 );
