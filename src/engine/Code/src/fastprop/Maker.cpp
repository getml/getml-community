...
Maker::fit( const MakerParams& _params )
{
    ...
    const auto feature_container = transform( MakerParams{
    ...
    for ( size_t i = 0; i < placeholder.propositionalization_.size(); ++i )
        {
            ...
            allow_lagged_targets.push_back(
                placeholder.allow_lagged_targets_.at( i ) );
            ...
            other_join_keys_used.push_back(
                placeholder.other_join_keys_used_.at( i ) );
            ...
            upper_time_stamps_used.push_back(
                placeholder.upper_time_stamps_used_.at( i ) );
        }
