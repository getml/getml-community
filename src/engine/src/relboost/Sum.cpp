...
std::vector<std::pair<Float, std::array<Float, 3>>> Sum::calc_pairs(
  ...
  results.emplace_back(child_->calc_pair(
      enums::Aggregation::sum, _revert, update_, _old_weight,
...
void Sum::calc_yhat(const enums::Aggregation _agg, const Float _old_weight,
...
Float Sum::evaluate_split(const Float _old_intercept, const Float _old_weight,
                          const std::array<Float, 3>& _weights,
                          const std::vector<containers::Match>::iterator _begin,
...
void Sum::revert(const Float _old_weight) {
  ...
  child_->calc_etas(enums::Aggregation::sum, update_, _old_weight,
