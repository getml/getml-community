...
std::string HumanReadableSQLGenerator::join_mapping(const std::string& _name,
...
std::string HumanReadableSQLGenerator::make_mapping_table_header(
...
std::string HumanReadableSQLGenerator::make_mapping_table_insert_into(
