#include "relmt/utils/ImportanceMaker.hpp"
...
void ImportanceMaker::add(const helpers::Schema& _input,
                          ...
                          const size_t _column, const size_t _column_input,
                          const Float _value) {
  switch (_data_used) {
    ...
    case enums::DataUsed::same_units_categorical:
      ...
      add(_input, _output, enums::DataUsed::categorical_output, _column, 0,
          _value * 0.5);

      add(_input, _output, enums::DataUsed::categorical_input, _column_input, 0,
          _value * 0.5);
    ...
    case enums::DataUsed::same_units_discrete:
      ...
      add(_input, _output, enums::DataUsed::discrete_output, _column, 0,
          _value * 0.5);

      add(_input, _output, enums::DataUsed::discrete_input, _column_input, 0,
          _value * 0.5);
    ...
    case enums::DataUsed::same_units_numerical:
      ...
      add(_input, _output, enums::DataUsed::numerical_output, _column, 0,
          _value * 0.5);

      add(_input, _output, enums::DataUsed::numerical_input, _column_input, 0,
          _value * 0.5);
    ...
    case enums::DataUsed::text_output: {
      ...
      const auto desc = helpers::ColumnDescription(peripheral(), _output.name(),
